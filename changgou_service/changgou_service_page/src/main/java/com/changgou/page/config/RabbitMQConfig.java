...
public class RabbitMQConfig {
    ...
    public static final String SEARCH_ADD_QUEUE="search_add_queue";//商品索引库新增队列

    public static final String SEARCH_DEL_QUEUE="search_del_queue";//商品索引库删除队列

    public static final String PAGE_CREATE_QUEUE="page_create_queue";//静态生成队列
    ...
    public Queue SEARCH_DEL_QUEUE(){return new Queue(SEARCH_DEL_QUEUE);}
